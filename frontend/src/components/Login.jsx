...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[#F8F9FA] p-4 font-sans sm:p-6 lg:p-12">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-10 lg:flex-row lg:gap-16">
          ...
          <div>
            ...
            <Link to="/" className="inline-flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-black tracking-tight text-[#0A1E14] sm:text-3xl">
                  ExamEye
                </span>
                {/* AI PROCTOR TEXT (Navbar ki tarah) */}
                <span className="text-xs font-bold tracking-[0.2em] text-[#092517] uppercase">
                  AI PROCTOR
                </span>
              </div>
            </Link>
        ...
        <div className="w-full lg:w-1/2 lg:max-w-[500px]">
          <div className="rounded-[28px] bg-white p-8 shadow-[0_20px_50px_rgba(0,0,0,0.06)] sm:p-10 lg:p-12">
            ...
            <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="relative mt-2">
                  ...
                  <input
                    ...
                    placeholder="teacher@exameye.edu.pk"
              ...
              <button
                type="submit"
                className="mt-2 w-full cursor-pointer rounded-2xl bg-[#092517] py-4 text-base font-semibold text-white shadow-md transition-all duration-300 hover:bg-[#071d12] hover:shadow-lg active:scale-[0.99]"
              >
                Sign In
              </button>
            </form>
